              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text('Each country has its own wedding traditions', style: dmSans(context, size: 12, color: AppColors.primary)),
                  ],
                ),
              ),
              Padding(
                ...
                child: WeddingCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Country & traditions', style: dmSans(context, size: 13, color: AppColors.textBrown, weight: FontWeight.w500)),
                      const SizedBox(height: 8),
                      Container(
                      ...
                      Text('Wedding type', style: dmSans(context, size: 12, color: AppColors.textMuted)),
                      const SizedBox(height: 8),
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'Expected guests: ${_selectedType.guestLimit}',
                        style: dmSans(context, size: 11, color: AppColors.primary),
                      ),
                      const SizedBox(height: 20),
                      Text('Your wedding', style: dmSans(context, size: 13, color: AppColors.textBrown, weight: FontWeight.w500)),
                      const SizedBox(height: 8),
                      WeddingInputField(label: 'Bride name', controller: _brideName, icon: Icons.favorite_outline, hint: 'Bride first name'),
                      const SizedBox(height: 16),
                      WeddingInputField(label: 'Groom name', controller: _groomName, icon: Icons.favorite_outline, hint: 'Groom first name'),
                      const SizedBox(height: 16),
                      WeddingInputField(label: 'Venue (optional)', controller: _venue, icon: Icons.location_on_outlined, hint: 'Hall, mosque, city...'),
                      const SizedBox(height: 16),
                      GestureDetector(
                        onTap: _pickDate,
                        child: AbsorbPointer(
                      ...
                      const SizedBox(height: 20),
                      Text('Your account', style: dmSans(context, size: 13, color: AppColors.textBrown, weight: FontWeight.w500)),
                      const SizedBox(height: 8),
