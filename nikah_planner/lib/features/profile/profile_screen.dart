                    ...
                    WeddingCard(
                      ...
                      child: Column(
                        children: [
                          ...
                          const _InfoRow(icon: Icons.calendar_today, iconColor: AppColors.accent, label: 'Wedding Date', value: '15 March 2025'),
                          const SizedBox(height: 12),
                          const _InfoRow(icon: Icons.location_on_outlined, iconColor: AppColors.secondary, label: 'Venue', value: 'Dewan Mulia, Shah Alam'),
                          const SizedBox(height: 12),
                          const _InfoRow(icon: Icons.favorite_outline, iconColor: Color(0xFFD4A0A0), label: 'Theme', value: 'Elegant Gold & Sage Green'),
                        ],
                      ),
                    ),
