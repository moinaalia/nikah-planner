...
All screenshots are stored in the [`screenshots/`](screenshots/) folder and displayed below.

### 11.1 Splash screen

![Splash screen — Nikah Planner app launch](screenshots/01_splash.png)

*File: `screenshots/01_splash.png`*

### 11.2 Login screen

![Login screen with email and password fields](screenshots/02_login.png)

*File: `screenshots/02_login.png`*

### 11.3 Register screen

![Register screen — create account form](screenshots/03_register.png)

*File: `screenshots/03_register.png`*

### 11.4 Dashboard (Home)

![Dashboard — countdown, tasks, and budget overview](screenshots/04_dashboard.png)

*File: `screenshots/04_dashboard.png`*

### 11.5 Budget / Reports

![Budget screen — pie chart and expense tracking](screenshots/05_budget.png)

*File: `screenshots/05_budget.png`*

### 11.6 Guest list and filters

![Guest list with RSVP filters](screenshots/06_guests.png)

*File: `screenshots/06_guests.png`*

### 11.7 Schedule

![Wedding schedule — event timeline](screenshots/07_schedule.png)

*File: `screenshots/07_schedule.png`*

### 11.8 Settings and profile

![Settings screen with profile and sign-out option](screenshots/08_settings.png)

*File: `screenshots/08_settings.png`*

### 11.9 Login error message

![Login error — invalid credentials message displayed](screenshots/09_error.png)

*File: `screenshots/09_error.png`*
